...
const copy = {
  en:{info:'About FantaFort',method:'Data methodology',cookies:'Cookie notice',note:'Independent fantasy experience. Not endorsed by Epic Games.'},
  it:{info:'Informazioni su FantaFort',method:'Metodo dati',cookies:'Informativa cookie',note:'Esperienza fantasy indipendente. Non approvata da Epic Games.'},
  es:{info:'Acerca de FantaFort',method:'Metodología de datos',cookies:'Aviso de cookies',note:'Experiencia independiente. No respaldada por Epic Games.'},
  de:{info:'Über FantaFort',method:'Datenmethodik',cookies:'Cookie-Hinweis',note:'Unabhängiges Fantasy-Erlebnis. Nicht von Epic Games unterstützt.'},
  fr:{info:'À propos de FantaFort',method:'Méthodologie des données',cookies:'Avis cookies',note:'Expérience indépendante. Non approuvée par Epic Games.'},
} satisfies Record<Locale, {info:string;method:string;cookies:string;note:string}>;

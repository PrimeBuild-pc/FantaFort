...
const labels: Record<Locale, { nav:string; how:string; players:string; events:string; login:string; signup:string; account:string }> = {
  en:{nav:'Public navigation',how:'How it works',players:'Players',events:'Tournaments',login:'Sign in',signup:'Create account',account:'Open game'},
  it:{nav:'Navigazione pubblica',how:'Come funziona',players:'Player',events:'Tornei',login:'Accedi',signup:'Crea account',account:'Apri il gioco'},
  es:{nav:'Navegación pública',how:'Cómo funciona',players:'Jugadores',events:'Torneos',login:'Entrar',signup:'Crear cuenta',account:'Abrir juego'},
  de:{nav:'Öffentliche Navigation',how:'So funktioniert es',players:'Spieler',events:'Turniere',login:'Anmelden',signup:'Konto erstellen',account:'Spiel öffnen'},
  fr:{nav:'Navigation publique',how:'Fonctionnement',players:'Joueurs',events:'Tournois',login:'Connexion',signup:'Créer un compte',account:'Ouvrir le jeu'},
};
